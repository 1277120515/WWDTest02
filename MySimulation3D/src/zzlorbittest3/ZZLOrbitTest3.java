...
public class ZZLOrbitTest3 {
    ...
    public static void main(String[] args) {
        ...
        String[][] satelliteXMLListArray = new String[][]{new String[]{"gf2_2.xml"}, new String[]{"pleiades1a_1.xml", "pleiades1b_1.xml"}, new String[]{"gf1_2.xml", "zy02c_2.xml"}, new String[]{"gf1_3.xml", "zy02c_3.xml"}, new String[]{"sj9a_2.xml"}, new String[]{"zy3_3.xml", "sj9a_3.xml"}, new String[]{"zy3_4.xml", "sj9a_4.xml"},
        new String[]{"pleiades1a_1.xml", "pleiades1b_1.xml"}, new String[]{"spot6_2.xml"}, new String[]{"zy3_3.xml", "sj9a_3.xml"}, new String[]{"zy02c_2.xml"},
        new String[]{"quickbird2_1.xml", "geoeye1_1.xml", "ikonos2_1.xml"}, new String[]{"spot6_2.xml"}, new String[]{"sj9a_2.xml"}, new String[]{"zy02c_2.xml"}, new String[]{"zy02c_3.xml"}, new String[]{"zy02c_4.xml"}, new String[]{"zy3_3.xml"}, new String[]{"zy3_4.xml"}
        };
        ...
        for (int gi = 0; gi < gridFileNameArray.length; gi++) {
            ...
            int[][] c = acs.calGridCoverage(ai,new AccessOutput());
